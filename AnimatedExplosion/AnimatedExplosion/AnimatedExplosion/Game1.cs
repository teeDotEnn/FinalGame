...
namespace AnimatedExplosion
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Texture2D tex = this.Content.Load<Texture2D>("Images/explosion");
            Vector2 stage = new Vector2(graphics.PreferredBackBufferWidth, graphics.PreferredBackBufferHeight);
            Vector2 position = new Vector2(50, 50);

            explosion = new Explosion(this, spriteBatch, tex, position, 3);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                explosion.Position = new Vector2(ms.X - 30, ms.Y - 30);
                explosion.start();
            }
            oldstate = ms;
